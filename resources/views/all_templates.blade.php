...
@stop
@section('custom_css')
    <link rel="stylesheet" id="elementor-post-59-css" href="{{asset('assets/css/post-59.css')}}"
          media="all" defer>
    ...
    <link rel="stylesheet" id="elementor-post-55-css"
          ...
          media="all" defer />
    <link rel="stylesheet" id="elementor-post-59-css" href="{{asset('assets/css/all_templates.css')}}"
          media="all" defer>
@endsection
                                ...
                                <div
                                    ...
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        ...
                                        <div
                                            ...
                                            data-widget_type="heading.default">
                                            <div class="elementor-widget-container">
                                                <h3 class="elementor-heading-title elementor-size-default">All CV
                                                    Template</h3></div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="exad-card left text_on_image yes">
                                                        <div class="exad-card-thumb" style="max-height: 496.7px">
                                                            <img loading="lazy" width="700" height="990"
                                                                 src="{{asset('files/'.$one->image)}}"
