...
<body style="">
<div class="Home" style="position:relative;display: table;">
    <aside class="col-personal" style="height:100%;background-color: #496267;">
        ...
        <table class="width100">
            @if(!empty($cv->image))
                <tr>
                    <td>
                        <img class="personal-image" src="{{asset('files/uploads/'.$cv->image)}}"
                             width="168"
                             height="168"
                             loading="lazy"/>
                    </td>
                    ...
                    <div class="personal-info-description mt-10">
                        <ul class="contact-list">
                            @if(!empty($cv->{"address_".$lang }))
                                <li>
                                    <p class="strong">{{__('Address:')}} {{$cv->{"address_".$lang } }}</p>
                                </li>
                            @endif
                            @if(!empty($cv->phone))
                            ...
                            @if(!empty($cv->{"city_town_".$lang}))
                                <li>
                                    <p class="strong">{{__('Country / City:')}} {{$cv->{"country_".$lang} . ' '. $cv->{"city_town_".$lang} }}</p>
                                </li>
                            @endif

                            @if(!empty($cv->nationality))
                                <li>
                                    <p class="strong">{{__('Nationality:')}} {{$cv->nationality}}</p>
                                </li>
                            @endif
                            @if(!empty($cv->linkedlin_url))
                                <li><p class="strong">{{__('Linkedin:')}} {{$cv->linkedlin_url}}</p>
                                </li>
                            @endif
                            @if(!empty($cv->website))
                                    ...
                                    <span class="txt-bold"
                                        ...
                                        <div class="field field-ratt">
                                            @if(!empty($language->{"level_".$lang}))
                                                <span
                                                    id="FIELD_RATT1">{{$language->{"level_".$lang} }}</span>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
    ...
    <main style="background: #fff">
        <div class="col-main" style="background: #fff">
            <table class="width100">
                <tr class="width100">
                    <td class="width100">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="458" height="8"
                             viewBox="0 0 458 8"
                             fill="none">
                ...
                @if(!empty($cv->{"summary_content_".$lang}))
                    <tr class="width100" >
                        <td class="width100">
                            <div class="objective-section section" style="width:80%">
            ...
            @if(count($cv->customer_cv_work_history))
                ...
                <div class="experience-section section">
                    ...
                    <table class="width100" style="width:90%">
                            ...
                            <tr class="width100">
                                <td class="width100">
                                    <div class="section-description mt-15 experience-item">
                                       ...
                                       <p style="width: 68%">{!! $work->{"experience_description_".$lang } !!}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
                ...
                <div class="education-section section">
                    ...
                    @foreach($cv->customer_cv_project as $project)
                        <div class="section-description mt-15 education-item">
                            ...
                            <p class="strong" style="width: 75%">{{$project->{"description_".$lang} }}</p>
                        </div>
                    @endforeach
                </div>
            @endif
