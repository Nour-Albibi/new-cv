<section data-particle_enable="false" data-particle-mobile-disabled="false"
        ...
        <div
            ...
            <div class="elementor-widget-wrap elementor-element-populated">
                ...
                <div
                    ...
                    data-widget_type="heading.default" current_tab="6">
                    <div class="elementor-widget-container">
                        <h6 class="elementor-heading-title elementor-size-default">{{__("Write a career summary to show companies how your background matches the job you want. If you’re applying for a job you haven’t done before, focus on your relevant experience and skills that the new job would use.")}}</h6>
                    </div>
                </div>
                <div
    ...
    <div class="cv_summaries_tab elementor-container elementor-column-gap-custom">
        <div
            class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-1cf01187 exad-glass-effect-no exad-sticky-section-no"
            data-id="1cf01187" data-element_type="column">
            <div class="elementor-widget-wrap elementor-element-populated">
                <div
                    class="elementor-element elementor-element-47332c22 exad-sticky-section-no exad-glass-effect-no hello-element elementor-invisible elementor-widget elementor-widget-heading"
                    data-id="47332c22" data-element_type="widget"
                    data-settings="{&quot;_animation&quot;:&quot;fadeInUp&quot;,&quot;_animation_delay&quot;:200}"
                    data-widget_type="heading.default" current_tab="6">
                    <div class="elementor-widget-container">
                        <h4 class="elementor-heading-title elementor-size-default">{{__('Briefly tell us about your background')}}</h4>
                    </div>
                </div>
                <div
                    class="elementor-element elementor-element-4cf1e1ac exad-sticky-section-no exad-glass-effect-no hello-element elementor-invisible elementor-widget elementor-widget-heading"
                ...
                <div
                    class="elementor-element elementor-element-78afe226 exad-sticky-section-no exad-glass-effect-no elementor-widget elementor-widget-wpforms"
                    ...
                    <div class="elementor-widget-container">
                        <div class="wpforms-container wpforms-container-full" id="wpforms-614">
                            <form id="summary_form" class="wpforms-validate wpforms-form"
                                ...
                                @csrf
                                <input name="summary_content" type="hidden"
                                       value="@if(!empty($addedItem)){{$addedItem->model->{"summary_content_".$cv_lang} }}@endif">
                                    ...
                                    <div id="wpforms-614-field_1-container"
                                        ...
                                        @if(!empty($addedItem) && count($addedItem->model->customer_cv_summery))
                                            @foreach($addedItem->model->customer_cv_summery as $addedSummary)
                                                <input type="hidden" class="summaries_idss" name="summaries_ids[]"
                                                       value="{{$addedSummary->id}}"/>
                                            @endforeach
                                        @endif
                                        <x-cv.tiny_editor id="wpforms-614-field_1" :selector="$editor_id"
                                                          class="wpforms-field-medium summary_content"
                                                          name="content_{{$cv_lang}}">
                                            @if(!empty($addedItem))
                                                {!!$addedItem->model->{"summary_content_".$cv_lang}  !!}
                                            @endif
                                        </x-cv.tiny_editor>
                                    </div>
                                </div>
