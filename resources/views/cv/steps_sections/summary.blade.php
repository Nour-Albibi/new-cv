<section data-particle_enable="false" data-particle-mobile-disabled="false"
            ...
            <div class="elementor-widget-wrap elementor-element-populated">
                <div class="elementor-element elementor-element-47332c22 exad-sticky-section-no exad-glass-effect-no elementor-invisible elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h4 class="elementor-heading-title elementor-size-default">Briefly tell us
                ...
                <div class="elementor-element elementor-element-4cf1e1ac exad-sticky-section-no exad-glass-effect-no elementor-invisible elementor-widget elementor-widget-heading"
                     ...
                     data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                        <h6 class="elementor-heading-title elementor-size-default">Use the samples
                                ...
                                <div class="wpforms-field-container">
                                    <div id="wpforms-614-field_2-container"
                                        ...
                                        <label class="wpforms-field-label"
                                               for="wpforms-614-field_2">Search for pre-written
                                            examples</label><input type="text"
                                                                   id="wpforms-614-field_2"
    ...
    border-radius: 5px;">Search
                                    ...
                                    <div id="wpforms-614-field_4-container"
                                        ...
                                        <div id="wpforms-614-field_4">
                                            ...
                                            <i class="fas fa-plus-circle"
                                               style="list-style:none"></i><span class="f"> Organized and dependable candidate successful at managing multiple priorities with a positive attitude.</span>

                                            <br>
                                            <i class="fas fa-plus-circle"
                                               style="list-style:none"></i> Hardworking and
                                            passionate job seeker with strong organizational skills
                                            <br>
                                        </div>
                                    </div>
                                    <div id="wpforms-614-field_1-container"
                                         ...
                                         data-field-id="1">
                                        <label class="wpforms-field-label"
                                               for="wpforms-614-field_1">Professional
                                            summary</label><textarea id="wpforms-614-field_1"
