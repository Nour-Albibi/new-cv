<section data-particle_enable="false" data-particle-mobile-disabled="false"
            ...
            <div class="elementor-widget-wrap elementor-element-populated">
                <div
                    ...
                    <div class="elementor-widget-container">
                        <h4 class="elementor-heading-title elementor-size-default">{{__('Tell us about your work history')}}</h4></div>
                </div>
                <div
                    ...
                    data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                        <h6 class="elementor-heading-title elementor-size-default">{{__('Start with your most recent job and work backwards.')}}</h6></div>
                </div>
                <div
                                ...
                                <div class="wpforms-field-container">
                                    ...
                                    <div id="wpforms-488-field_4-container"
                                        ...
                                        <label class="wpforms-field-label"
                                            ...
                                            <textarea class="wpforms-field-large" name="work_1[experience_description_{{$lang}}]" placeholder="{{__('Job Description')}}"></textarea>
                                    </div>
                                </div>
                              </div>
    ...
    border-radius: 5px;" type="button" onclick="AddWorkExperience()">+</button>
                                    </div>
                                </div>
                            </form>
                        </div>
