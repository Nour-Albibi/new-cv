                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-centered datatable dt-responsive nowrap "
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(\App\Services\CustomerService::canSubscribeToNewCompanyPackage())
                                        <a href="{{url('company/subscriptions/create_new?package_id='.$subscription->package_id)}}"><i class="fa fa-refresh"></i></a>
                                    @endif
                                </td>
                            </tr>
                            </tbody>
