        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body  pt-0">
                    ...
                    <form name="doCheckOut" id="doCheckOut" action="{{route('company.subscriptions.store_new')}}"
                          method="post">
                        @csrf
                        <input type="hidden" name="package_id" value="@if(!empty(request()->package_id)){{request()->package_id}} @else {{$packages[0]->id}} @endif"/>
                                                ...
                                                <div class="row p-2">
                                                            ...
                                                            @else
                                                                <div class="row mt-4 mb-4 ">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="text-uppercase">{{__('Choose Your Package')}}</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row" style="margin-bottom:16px;">
                                                                    ...
                                                                    @foreach($packages as $pkg)
                                                                        <div class="col-md-4 col-sm-6 pacakge_box @if($i==0) active @endif"
                                                                             package_id="{{$pkg->id}}">
                                                    ...
                                                    <div class="col-md-12 mt-1">
                                                        <div class="form-group text-end">
                                                            ...
                                                            <button type="reset"
                                                                    class="btn btn-secondary">{{__('Clear')}}</button>
                                                        </div>
                                                    </div>
