                                ...
                                <g clip-path="url(#clp3)">
                                    ...
                                    <g class="ps00">
                                        ...
                                        <g clip-path="url(#clp5)">
                                            <g class="ps00">
{{--                                                <text transform="matrix(1 0 0 1 287.825 71)"><tspan x="0,17.328,32.16" class="ps01 ps20">CON</tspan>--}}
{{--                                                    <tspan x="45.624,59.064,70.344,81.624" class="ps01 ps20">NELL</tspan>--}}
{{--                                                </text>--}}
                                            </g>
                                        </g>
                                    </g>
