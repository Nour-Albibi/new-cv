...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="customer-assets/images/favicon1.ico">

        <!-- Bootstrap Css -->
        <link href="/customer-assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="/customer-assets/css/icons.min.css" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="/customer-assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <!-- JAVASCRIPT -->
        <script src="/customer-assets/libs/jquery/jquery.min.js"></script>
        <script src="/customer-assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="/customer-assets/libs/metismenu/metisMenu.min.js"></script>
        <script src="/customer-assets/libs/simplebar/simplebar.min.js"></script>
        <script src="/customer-assets/libs/node-waves/waves.min.js"></script>
