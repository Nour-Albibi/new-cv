...
class CustomerPackageController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'CustomerPackage';
    ...
    {
        $grid = new Grid(new CustomerPackage());
        ...
        $grid->column('is_active', __('Status'))->switch($states);        $grid->column('created_at', __('Created at'))->display(function (){
    ...
    {
        $show = new Show(CustomerPackage::findOrFail($id));
    ...
    {
        $form = new Form(new CustomerPackage());
